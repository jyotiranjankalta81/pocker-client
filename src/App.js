...
// // // const App = () => {
// // //     const [players, setPlayers] = useState([{ id: 1, diceValues: [1, 1, 1, 1, 1], rolling: false }]);
// // //     const [result, setResult] = useState('');
// // //     const [numPlayers, setNumPlayers] = useState(1);

// // //     const addPlayer = () => {
// // //         setPlayers([...players, { id: players.length + 1, diceValues: [1, 1, 1, 1, 1], rolling: false }]);
...
// // //                 player.rolling = true;
// // //                 setTimeout(() => {
// // //                     player.diceValues = player.diceValues.map(() => Math.floor(Math.random() * 6) + 1);
...
// // //             <button onClick={calculateWinner} className="calculate-winner-button">Calculate Winner</button>
// // //             {result && <h2>{result}</h2>}
// // //         </div>
// // //     );
// // // };
...
// //         { id: 1, diceValues: [1, 1, 1, 1, 1], rolling: false, rollsLeft: 5 }
// //     ]);
// //     const [result, setResult] = useState('');
// //     const [numPlayers, setNumPlayers] = useState(1);
...
// //         setPlayers([
// //             ...players,
// //             { id: players.length + 1, diceValues: [1, 1, 1, 1, 1], rolling: false, rollsLeft: 5 }
// //         ]);
// //         setNumPlayers(numPlayers + 1);
// //     };
...
// //                     player.diceValues = player.diceValues.map(() => Math.floor(Math.random() * 6) + 1);
// //                     player.rolling = false;
// //                     player.rollsLeft = player.rollsLeft - 1;
// //                     setPlayers([...players]);
// //                 }, 1000);
// //             }
// //             return player;
